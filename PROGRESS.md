...
- Full container test suite passes: 10 passed, 2 skipped when live integration env is not set.
- Live API integration tests pass: 2 passed with `HERMES_TEST_BASE_URL=http://localhost:8000`.
...
- Live API integration tests now cover the fake downstream success and failure paths: 3 passed.
